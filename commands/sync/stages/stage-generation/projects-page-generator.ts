    ...
    <div>
      <div className="mb-6 grid grid-cols-5 gap-4">
        <button
          ...
          style={{
            backgroundColor: typeFilter === 'Chain' ? 'rgb(var(--primary-light) / 0.15)' : 'rgb(var(--gray-200) / 0.05)',
        ...
        <button
          ...
          className="text-center p-3 rounded-lg transition-all cursor-pointer hover:scale-105"
          style={{
            backgroundColor: typeFilter === 'Project' ? 'rgb(var(--primary-light) / 0.15)' : 'rgb(var(--gray-200) / 0.05)',
        ...
        <button
          ...
          className="text-center p-3 rounded-lg transition-all cursor-pointer hover:scale-105"
          style={{
            backgroundColor: typeFilter === 'ETF' ? 'rgb(var(--primary-light) / 0.15)' : 'rgb(var(--gray-200) / 0.05)',
        ...
        <button
          ...
          className="text-center p-3 rounded-lg transition-all cursor-pointer hover:scale-105"
          style={{
            backgroundColor: typeFilter === 'Treasury' ? 'rgb(var(--primary-light) / 0.15)' : 'rgb(var(--gray-200) / 0.05)',
        ...
        <button
          ...
          className="text-center p-3 rounded-lg transition-all cursor-pointer hover:scale-105"
          style={{
            backgroundColor: typeFilter === 'all' ? 'rgb(var(--primary-light) / 0.15)' : 'rgb(var(--gray-200) / 0.05)',
      ...
      <div className="mb-4 flex gap-4">
        <input
          ...
          style={{ backgroundColor: 'rgb(var(--gray-200) / 0.05)', borderColor: 'rgb(var(--primary-light) / 0.2)' }}
          value={search}
          ...
          <tbody>
            {filteredProjects.map((project, idx) => (
              <>
                <tr 
                  ...
                  onMouseEnter={(e) => {
                    if (!expandedProject || expandedProject !== idx) {
                      e.currentTarget.style.backgroundColor = 'rgb(var(--gray-200) / 0.05)'
                    }
                  }}
                  onMouseLeave={(e) => {
                    if (!expandedProject || expandedProject !== idx) {
                ...
                {expandedProject === idx && (
                  <tr style={{ backgroundColor: 'rgb(var(--gray-200) / 0.05)' }}>
