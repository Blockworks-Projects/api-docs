---
title: Welcome
description: "A high-signal crypto data API that ships curated, production‑ready metrics and chart datasets."
icon: house
---
...
- **Waitlist now open:** We’ll expand access gradually as we scale infrastructure and refine endpoints. [Join the waitlist here](https://app.blockworksresearch.com/?modal=share-feedback).
