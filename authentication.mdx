...
| Where to get it | [Blockworks Research](https://app.blockworksresearch.com) → User Dropdown → Account Management → [API](https://app.blockworksresearch.com/settings/api-keys) |
