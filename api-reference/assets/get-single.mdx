...
openapi: 'GET /v1/assets/{idOrSlug}/x'
---

import { Endpoint } from '/snippets/endpoint.mdx'

<Endpoint method="GET" path="/v1/assets/{idOrSlug}" />
...
curl -H "x-api-key: YOUR_API_KEY" \
  ...
  https://api.blockworksresearch.com/v1/assets/bitcoin
```
...
```bash cURL
curl -H "x-api-key: YOUR_API_KEY" \
  "https://api.blockworksresearch.com/v1/assets/bitcoin?expand=supply,ohlcv_last_24_h"
```

```typescript TypeScript
const response = await fetch('https://api.blockworksresearch.com/v1/assets/bitcoin?expand=supply,ohlcv_last_24_h', {
  headers: { 'x-api-key': 'YOUR_API_KEY' }
})
