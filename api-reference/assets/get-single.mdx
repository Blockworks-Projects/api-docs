...
openapi: 'GET /v3/assets/{idOrSlug}'
---

import { Endpoint } from '/snippets/endpoint.mdx'

<Endpoint method="GET" path="/v3/assets/{idOrSlug}" size="xl" />
...
### Example: Adding supply and OHLCV data

The following endpoint demonstrates the expansion of the `supply` and `ohlcv_last_24_h` fields.

<Endpoint method="GET" path="/v3/assets/bitcoin?expand=supply,ohlcv_last_24_h" size="md" />
