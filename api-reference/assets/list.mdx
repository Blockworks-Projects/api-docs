...
curl -H "x-api-key: YOUR_API_KEY" \
  ...
  "https://api.blockworksresearch.com/v1/assets?limit=20"
```
...
response = requests.get(
    'https://api.blockworksresearch.com/v1/assets',
    headers = { 'x-api-key': 'YOUR_API_KEY' },
    params = { 'limit': 20 }
)
...
| `category` | string, comma-separated | No | Filter by asset category(s) | `Infrastructure,Services` |
...
```bash cURL
curl -H "x-api-key: YOUR_API_KEY" \
  "https://api.blockworksresearch.com/v1/assets?category=Infrastructure&limit=2"
```

```typescript TypeScript
const response = await fetch('https://api.blockworksresearch.com/v1/assets?category=Infrastructure&limit=2', {
  headers: { 'x-api-key': 'YOUR_API_KEY' }
})
...
```bash cURL
curl -H "x-api-key: YOUR_API_KEY" \
  "https://api.blockworksresearch.com/v1/assets?expand=price,market_cap&limit=2"
```

```typescript TypeScript
const response = await fetch('https://api.blockworksresearch.com/v1/assets?expand=price,market_cap&limit=2', {
  headers: { 'x-api-key': 'YOUR_API_KEY' }
})
