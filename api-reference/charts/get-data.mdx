...
openapi: 'GET /v1/charts/{visualizationIdOrDashboardSlug}/data'
mode: 'wide'
---

## Overview

Fetch chart data by **visualization ID** or **dashboard slug**. This endpoint returns the underlying data powering charts and visualizations, with support for pagination, filtering, and sorting.
