...
| Arbitrum | `adress-total` | Blockworks | daily | timeseries_int |
...
| Base | `issuance` | Blockworks | daily | timeseries_float |
| Arbitrum | `issuance` | Blockworks | daily | timeseries_float |

## Issuance USD

There is no issuance on Arbitrum


| Chain | Identifier | Source | Interval | Data Type |
|-------|------------|--------|----------|-----------|
| Arbitrum | `issuance-usd` | Blockworks | daily | timeseries_usd |
| Base | `issuance-usd` | Blockworks | daily | timeseries_usd |
...
| Base | `fees-mev-tips` | Blockworks | daily | timeseries_float |
| Solana | `fees-mev-tips` | Blockworks | daily | timeseries_float |
| Arbitrum | `fees-mev-tips` | Blockworks | daily | timeseries_float |

## MEV Tips USD

There are no MEV tips on Arbitrum


| Chain | Identifier | Source | Interval | Data Type |
|-------|------------|--------|----------|-----------|
| Arbitrum | `fees-mev-tips-usd` | Blockworks | daily | timeseries_usd |
| Solana | `fees-mev-tips-usd` | Blockworks | daily | timeseries_usd |
| Base | `fees-mev-tips-usd` | Blockworks | daily | timeseries_usd |
...
| Solana | `fees-other` | Blockworks | daily | timeseries_float |

## Other Fees USD

There are no other fees on Solana


| Chain | Identifier | Source | Interval | Data Type |
|-------|------------|--------|----------|-----------|
| Solana | `fees-other-usd` | Blockworks | daily | timeseries_float |
| Arbitrum | `fees-other-usd` | Blockworks | daily | timeseries_usd |
| Base | `fees-other-usd` | Blockworks | daily | timeseries_usd |
